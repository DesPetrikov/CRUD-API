...
import { INCONSISTENT_DATA, INVALID_USER_ID, USER_NOT_FOUND } from '../constants.js';
import { userType } from '../types.js';
import { getRequestBody, isValidUser } from '../utils.js';

export const putController = async (req: IncomingMessage, userId: string, usersList: userType[]) => {
  if (!validate(userId)) {
